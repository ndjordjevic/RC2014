...
> **Created:** 2026-06-15 | **Detail level:** standard (default; per-source overrides via `<!-- detail:X -->` inbox tags)

---

## For AI agents working in this repo

Before answering **any question** about RC2014 retro computer, you MUST:
