# RC2014 retro computer wiki

A personal knowledge base for **RC2014 retro computer**, maintained with [pin-llm-wiki](https://github.com/ndjordjevic/pin-llm-wiki).
...
If you ask questions from **another repo** but want agents to use this wiki, add that instruction there—in `CLAUDE.md` or `AGENTS.md`—to consult this wiki’s `wiki/index.md` (and follow `[[wikilinks]]`) for **RC2014 retro computer**.
...
AI agents in this repo are instructed to consult this wiki before answering questions about **RC2014 retro computer**. See `AGENTS.md` for the exact protocol.
